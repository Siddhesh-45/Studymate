...
// ── STUDENT ONLY: mark topic/video complete ─────────────────────────────────
// PATCH /api/course/:id/topic/:topicId/toggle
// Updates the student's CourseProgress record without mutating the shared course
...
router.patch('/:courseId/topic/:topicId', auth, studentOnly, courseCtrl.toggleTopicStatus);
router.patch('/:id/topic/:topicId/toggle', auth, studentOnly, courseCtrl.toggleTopicStatus);

// ── STUDENT ONLY: enroll in a course ─────────────────────────────────────────
// POST /api/course/enroll  — body: { userId, courseId }
// Must be declared BEFORE /:id routes so "enroll" isn't matched as a param
