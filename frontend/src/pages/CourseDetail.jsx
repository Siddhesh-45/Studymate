...
export default function CourseDetail() {
  ...
  if (loading) return (
    <div style={S.center}>
      <div style={S.spinner} />
      <p style={{ color: '#94a3b8', marginTop: 16 }}>Loading course...</p>
    </div>
  );
              ...
              return (
                ...
                >
                  ...
                  <div style={S.lessonInfo}>
                    <p style={{ ...S.lessonName, color: active ? '#f1f5f9' : done ? '#86efac' : '#cbd5e1' }}>
                      {topic.title}
                    </p>
...
const S = {
  page:       { padding: '28px 36px', color: '#e2e8f0', fontFamily: "'Segoe UI', system-ui, sans-serif", position: 'relative' },
  backBtn:    { background: 'none', border: 'none', color: '#818cf8', cursor: 'pointer', fontSize: '14px', fontWeight: 500, marginBottom: '16px', padding: 0 },
  title:      { fontSize: '28px', color: '#f8fafc', margin: '0 0 8px', fontWeight: 700, letterSpacing: '-0.4px' },
  desc:       { color: '#94a3b8', fontSize: '15px', marginBottom: '20px', lineHeight: 1.6, maxWidth: '700px' },

  progressWrap: { background: 'rgba(255,255,255,0.03)', borderRadius: '12px', padding: '16px 20px', marginBottom: '28px', border: '1px solid rgba(255,255,255,0.06)' },
  progressRow:  { display: 'flex', justifyContent: 'space-between', marginBottom: '8px' },
  progressLabel:{ fontSize: '13px', color: '#94a3b8', fontWeight: 500 },
  progressPct:  { fontSize: '13px', color: '#a5b4fc', fontWeight: 600 },
  ...
  playlistCol:{ flex: '0 0 360px', background: 'rgba(255,255,255,0.02)', borderRadius: '16px', border: '1px solid rgba(255,255,255,0.06)', overflow: 'hidden' },

  playerCard: { background: 'rgba(255,255,255,0.02)', borderRadius: '16px', overflow: 'hidden', border: '1px solid rgba(255,255,255,0.06)', boxShadow: '0 8px 32px rgba(0,0,0,0.25)' },
  iframe:     { width: '100%', aspectRatio: '16/9', display: 'block', background: '#000' },
  noVideo:    { width: '100%', aspectRatio: '16/9', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#0f172a', color: '#475569', fontSize: '18px' },
  ...
  videoTitle:    { fontSize: '20px', margin: '0 0 10px', color: '#f1f5f9', fontWeight: 600, lineHeight: 1.3 },
  ...
  badgePending:  { background: 'rgba(255,255,255,0.06)', color: '#94a3b8', border: '1px solid rgba(255,255,255,0.1)' },
  metaDetail:    { fontSize: '13px', color: '#64748b' },
  watchLink:     { fontSize: '13px', color: '#818cf8', textDecoration: 'none', fontWeight: 500 },
  ...
  emptyPlayer: { padding: '80px 20px', textAlign: 'center', background: 'rgba(255,255,255,0.02)', borderRadius: '16px', color: '#64748b', fontSize: '16px' },

  playlistHeader:{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '18px 20px', borderBottom: '1px solid rgba(255,255,255,0.07)' },
  playlistTitle: { margin: 0, fontSize: '16px', fontWeight: 600, color: '#f8fafc' },
  playlistCount: { fontSize: '12px', color: '#818cf8', fontWeight: 600, background: 'rgba(99,102,241,0.12)', padding: '3px 10px', borderRadius: '20px' },
  playlist:      { maxHeight: '560px', overflowY: 'auto' },

  lessonRow:       { display: 'flex', alignItems: 'center', gap: '14px', padding: '14px 20px', cursor: 'pointer', borderBottom: '1px solid rgba(255,255,255,0.03)', transition: 'background 0.15s' },
  lessonRowActive: { background: 'rgba(99,102,241,0.1)' },
  lessonRowDone:   { background: 'rgba(34,197,94,0.03)' },

  lessonNum:       { width: '28px', height: '28px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '12px', fontWeight: 700, flexShrink: 0, background: 'rgba(255,255,255,0.06)', color: '#64748b' },
  lessonNumActive: { background: 'rgba(99,102,241,0.25)', color: '#818cf8' },
  ...
  lessonMeta:  { margin: '3px 0 0', fontSize: '12px', color: '#64748b' },
  nowPlaying:  { color: '#818cf8', fontSize: '14px', flexShrink: 0 },

  center:   { display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '100px 20px' },
  spinner:  { width: '40px', height: '40px', border: '3px solid rgba(255,255,255,0.1)', borderTopColor: A, borderRadius: '50%', animation: 'spin 0.9s linear infinite' },
  errorBox: { margin: '40px', padding: '20px 24px', background: 'rgba(239,68,68,0.1)', color: '#fca5a5', borderRadius: '12px', border: '1px solid rgba(239,68,68,0.2)', fontSize: '15px' },
  ...
  toastErr: { background: 'rgba(239,68,68,0.18)', color: '#fca5a5', border: '1px solid rgba(239,68,68,0.35)' },
};
