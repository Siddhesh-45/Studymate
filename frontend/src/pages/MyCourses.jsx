    ...
    <div style={S.page}>
      ...
      {totalCourses > 0 && (
        <div style={S.statsBar}>
          ...
          <div style={S.statDivider} />
          <div style={S.statItem}>
            <span style={{ ...S.statNum, color: '#a5b4fc' }}>{avgProgress}%</span>
      ...
      {courses.length === 0 && (
        <div style={S.emptyBox}>
          ...
          <p style={S.emptySubtitle}>
            Go to <strong style={{ color: '#a5b4fc' }}>All Courses</strong> and click
              ...
              <div style={S.cardBody}>
                ...
                <div style={S.progressSection}>
                  <div style={S.progressRow}>
                    ...
                    <span style={{ ...S.progressPct, color: isDone ? '#86efac' : '#a5b4fc' }}>
                      {progress}%
                    </span>
                  </div>
                  ...
                  <div style={S.lessonCount}>
                    <span style={{ color: isDone ? '#86efac' : '#a5b4fc', fontWeight: 600 }}>
                      {completed}
                    </span>
                    <span style={{ color: '#64748b' }}> / {total} lessons completed</span>
                  </div>
                </div>
...
const S = {
  ...
  title:      { fontSize: '28px', fontWeight: '700', color: '#e2e8f0', margin: 0, marginBottom: '6px', letterSpacing: '-0.5px' },
  subtitle:   { color: 'rgba(255,255,255,0.45)', fontSize: '14px', margin: 0, lineHeight: '1.5' },
  ...
  statsBar:    { display: 'flex', alignItems: 'center', background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.07)', borderRadius: '14px', padding: '16px 24px', marginBottom: '28px', gap: '16px', flexWrap: 'wrap' },
  ...
  overallTrack:{ height: '8px', background: 'rgba(255,255,255,0.08)', borderRadius: '4px', overflow: 'hidden' },
  overallFill: { height: '100%', background: 'linear-gradient(90deg,#6366f1,#8b5cf6)', borderRadius: '4px', transition: 'width 0.6s ease' },

  emptyBox:    { textAlign: 'center', padding: '80px 24px', background: 'rgba(255,255,255,0.02)', border: '1px dashed rgba(255,255,255,0.1)', borderRadius: '20px' },
  ...
  emptySubtitle:{ color: 'rgba(255,255,255,0.4)', fontSize: '14px', margin: '0 0 20px', lineHeight: '1.6' },
  ...
  card:     { background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '16px', overflow: 'hidden', display: 'flex', flexDirection: 'column', transition: 'border-color 0.2s' },
  cardDone: { border: '1px solid rgba(34,197,94,0.2)', background: 'rgba(34,197,94,0.03)' },

  cardBanner:     { height: '80px', background: 'linear-gradient(135deg, rgba(99,102,241,0.15) 0%, rgba(139,92,246,0.2) 100%)', display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'relative', borderBottom: '1px solid rgba(255,255,255,0.06)' },
  ...
  selectedBadge:  { position: 'absolute', top: '8px', right: '8px', background: 'rgba(99,102,241,0.2)', border: '1px solid rgba(99,102,241,0.4)', borderRadius: '20px', padding: '3px 10px', color: '#a5b4fc', fontSize: '11px', fontWeight: '600' },
  ...
  courseTitle:{ fontSize: '16px', fontWeight: '700', color: '#e2e8f0', margin: 0, lineHeight: '1.4' },
  courseDesc: { fontSize: '13px', color: 'rgba(255,255,255,0.45)', margin: 0, lineHeight: '1.5', display: '-webkit-box', WebkitLineClamp: 2, WebkitBoxOrient: 'vertical', overflow: 'hidden' },

  progressSection: { marginTop: '4px' },
  progressRow:     { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '6px' },
  progressLabel:   { color: 'rgba(255,255,255,0.4)', fontSize: '12px', fontWeight: '500' },
  progressPct:     { fontSize: '13px', fontWeight: '700' },
  progressTrack:   { height: '7px', background: 'rgba(255,255,255,0.08)', borderRadius: '4px', overflow: 'hidden' },
  progressFill:    { height: '100%', borderRadius: '4px', transition: 'width 0.4s ease' },
  lessonCount:     { marginTop: '5px', fontSize: '12px', color: '#64748b' },

  metaRow: { display: 'flex', gap: '8px', flexWrap: 'wrap', marginTop: 'auto', paddingTop: '6px' },
  metaTag: { background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '20px', padding: '3px 10px', color: 'rgba(255,255,255,0.5)', fontSize: '12px' },
  ...
  removeBtn: { padding: '10px 14px', borderRadius: '10px', fontSize: '14px', cursor: 'pointer', border: '1px solid rgba(239,68,68,0.3)', background: 'rgba(239,68,68,0.08)', color: '#fca5a5', transition: 'all 0.2s' },
